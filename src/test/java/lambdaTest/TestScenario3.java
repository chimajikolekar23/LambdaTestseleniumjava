...
public class TestScenario3 {
	...
	String username = "chimaji_kolekar";
	String accessKey = "slLi7TmbYS825CdcnqKp3yYPerAQ4bRKL54n2bxUyL5ddnb6L7";
...
//fill the form field
		...
		driver.findElement(By.cssSelector("#inputAddress1")).sendKeys("AP-pune aria sighgad road");
		driver.findElement(By.cssSelector("#inputAddress2")).sendKeys("Samarth nagar pune road");
		driver.findElement(By.cssSelector("#inputState")).sendKeys("Maharashtra");
		driver.findElement(By.cssSelector("#inputZip")).sendKeys("415105");
